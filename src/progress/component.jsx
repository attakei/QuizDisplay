...
ProgressComponent = React.createClass({
    ...
    render: function(){
        ...
        for (var i = 0; i < this.props.players.length; i++) {
            ...
            players.push(
                <div className="col-md-1 player-column" onClick={this.tryAnswer} data-playerid={i} data-answer={this.props.players[i].isAnswer}>
                    {playerIdTag}
                    <p className="text-center player-name">{this.props.players[i].name}</p>
                    <p className="text-center player-score">○1</p>
                    <p className="text-center player-score">○1</p>
                </div>
            );
        }
